<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (auth()->user()?->hasRole('user'))
                        <x-nav-link :href="route('pasien.profile.edit')" :active="request()->routeIs('pasien.profile.*')">
                            Profil Pasien
                        </x-nav-link>
                    ...
                    @if (auth()->user()?->hasRole('super_admin'))
                        <x-nav-link :href="route('super.users')" :active="request()->routeIs('super.users')">
                            Kelola User
                        </x-nav-link>
                        <x-nav-link :href="route('super.roles')" :active="request()->routeIs('super.roles*')">
                            Kelola Role
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (auth()->user()?->hasRole('user'))
                <x-responsive-nav-link :href="route('pasien.profile.edit')" :active="request()->routeIs('pasien.profile.*')">
                    Profil Pasien
                </x-responsive-nav-link>
